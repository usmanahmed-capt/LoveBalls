...
using UnityEditor;
	...
	public class MiniGamesEditorManager
	{
		...
		{
			I2.I2AboutWindow.PluginsVersion["I2 MiniGames"] = MiniGame_Inspector.GetVersion();
		}
	}
	...
	public class MiniGame_Inspector : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			if (GUILayout.Button("v"+GetVersion(), EditorStyles.miniLabel))
				Application.OpenURL(HelpURL_ReleaseNotes);
